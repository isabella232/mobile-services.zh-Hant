...
topic: 開發人員和實施
uuid: 8b374see-1432-460b-aac2-70623dd80 a04
...
Adobe Mobile Services 提供的新使用者介面，將 Adobe Experience Cloud 適用於行動應用程式的各項行動行銷功能整合在一起。Mobile服務一開始可完美整合Adobe Analytics、Adobe Audience Manager和Adobe Target解決方案的應用程式分析和定位功能，以及Adobe Experience Platform Identity Service。
